...
- Allow configuring widgetCategory

## [0.22.1] - 2026-08-17

### Fixed

- Constrain `ListWidget` overlay to widget bounds

## [0.22.0] - 2026-08-08

### Added

- Add `requestPinWidget` to show the launcher's native add-widget prompt on supported Android launchers
